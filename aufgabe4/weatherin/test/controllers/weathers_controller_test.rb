...
class WeathersControllerTest < ActionController::TestCase
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post :create, weather: { city: @weather.city, temperature: @weather.temperature, value: @weather.value }
    end
  ...
  test "should update weather" do
    patch :update, id: @weather, weather: { city: @weather.city, temperature: @weather.temperature, value: @weather.value }
    assert_redirected_to weather_path(assigns(:weather))
  end
